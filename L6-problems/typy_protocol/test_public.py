...
from . import type_protocol
from .type_protocol import get
...
def test_protocol() -> None:
    ...
    check_func(type_protocol, case1, True)
    check_func(type_protocol, case2, False)
    check_func(type_protocol, case3, True)
