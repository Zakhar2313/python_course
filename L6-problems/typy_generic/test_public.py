...
from . import type_generic
from .type_generic import Pair
...
def test_func5() -> None:
    ...
    check_func(type_generic, case1, False)
    check_func(type_generic, case2, False)
    check_func(type_generic, case3, True)
    check_func(type_generic, case4, True)
    check_func(type_generic, case5, True)
    check_func(type_generic, case6, False)
